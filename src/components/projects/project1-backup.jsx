    ...
    <div className="column-parent">
      <div className="column-container">
        ...
        <div className="column">
          ...
          <p>
            Prepared microscope slide by placing particles and DI-H2O on top of
            slide. Covered particles and liquid with coverslip. Placed a dot of
            immersion oil on top of coverslip and lowered microscope objective
            into oil. Took images of microspheres to use as calibration. Using
            radius= 1.72 microns, found horizontal calibration to be 0.0860
            microns/pixel and vertical calibration to be 0.0819 microns/pixel.
          </p>
          <div className="section-subtitle">Motion:</div>
          <p>
            Diluted sample with DI-H2O and caught a single particle in the
            beam-path. Tuned current to 62.23 mA to allow for thermal motion to
            be recorded. Took 5000 frames of data at 30.00Hz.
          </p>
          <div className="section-subtitle">Strength:</div>
          <p>
            Trapped a single particle at 62.60 mA of current. Recorded 500
            frames of data, moving the beam with acceleration until the particle
            was freed from the trap. Using radius= 1.72 microns and denisty=
            1.055 g/cm3 at room temperature, calculated the mass of each
            microsphere to be 2.249E−14 kg. This information was used to
            calculate the velocity: v = 7.758 microns/second 5
          </p>
