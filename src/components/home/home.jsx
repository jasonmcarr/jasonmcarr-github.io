  ...
  return (
    <section className="home-container">
      <div className="author-summary">
        ...
        formative years trekking the faces of indomitable mountains, breaking
        the glassy surface of waters rarely-touched, and watching the embers
        rise from the flames below them on cool summer evenings. This love of
        nature inspired me to pursue an understanding of it academically, which
        led me to Physics.
        <br />
        <br />
        ...
        world in an equivalently beautiful way. One of the best ways to chisel
        the form from the marble is through the use of data analysis.
        <br />
        <br />
